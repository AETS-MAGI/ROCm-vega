...
- solver selected: ConvAsm1x1U
- kernel selected: miopenGcnAsmConv1x1U
- dot4 instruction present: not checked in this case
- additional comments: Direct path selected on gfx900:xnack-; no fallback signature was captured# TRACE MAP TEMPLATE
