...
- `00_legacy-repos/MIOpen` は現時点で working tree 未展開のため、metadata ベースの履歴対象として扱う。
...
- `00_legacy-repos/MIOpen` は remote は `https://github.com/ROCm/MIOpen` だが、現時点では working tree が未展開で、履歴比較は保留
