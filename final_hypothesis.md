...
作成日: 2026-03-17
関連文書: `hypothesis.md`, `facts.md`, `class_map.md`, `support_boundary.md`, `provenance_map.md`, `reveal_hypothesis.md`, `trace_map_static.md`, `trace_map_dynamic.md`
...
timeline
    ...
    2024 : Tensile lazy loading fallback (外部 contributor, PR-1862 → revert PR-1879)
         : hipCUB gfx900 default build から後退 (ROCm 7.0)
