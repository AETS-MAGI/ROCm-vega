...
- `ROCm/CHANGELOG.md`
  - `rocSOLVER (3.26.0, ROCm 6.2.0 block)`: `Added gfx900 to default build targets.`
  - `Tensile (4.36.0, ROCm 5.5.0 block)`: `Add gfx900:xnack-, gfx1032, gfx1034, gfx1035`
  - `hipCUB (4.0.0, ROCm 7.0.0 block)`: `gfx803` / `gfx900` are no longer built by default
- `MIOpen`
  - commit `2407d2f556c7635de3f4b3f009681bdd92ba82e2`
